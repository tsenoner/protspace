...
def run_prepare_json_script():
    command = [
        ...
        "--features", "phylum,protein_existence,length_fixed,length_quantile,pfam,cath,superfamily,signal_peptide", # uncomment to get all the available protein features
        "--methods", "pca2,pca3",
