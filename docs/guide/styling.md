...
| `shapeSize`         | int      | `5`           | yes    | Marker size in the scatter plot. Applies until the user picks a size in the web app, which then holds for every annotation. A legacy `30` reads as the default.                       |
