# prep-failure-routing Specification

## Purpose

How FASTA-preparation failures are classified on the backend and surfaced to the user, including routing a Biocentral-unavailable failure to the Google Colab notebook.
