...
SAMPLE_TAXONOMY_FEATURES = {
    9606: {
        "features": {"genus": "Homo", "species": "Homo sapiens", "kingdom": "Metazoa"}
    },
    10090: {
        "features": {"genus": "Mus", "species": "Mus musculus", "kingdom": "Metazoa"}
    },
}
...
class TestProteinFeatureExtractorInit:
    ...
    def test_init_with_invalid_features(self):
        ...
        with pytest.raises(
            ValueError, match="Feature invalid_feature is not a valid feature"
        ):
...
class TestFeatureMerger:
    ...
    def test_merge_basic(self):
        ...
        uniprot_features = [
            ProteinFeatures(
                identifier="P01308", features={"organism_id": "9606", "length": "110"}
            ),
            ProteinFeatures(
                identifier="P01315", features={"organism_id": "10090", "length": "142"}
            ),
        ]
    ...
    def test_merge_missing_taxonomy(self):
        ...
        uniprot_features = [
            ...
            ProteinFeatures(
                identifier="P01315", features={"organism_id": "99999"}
            ),  # Missing
        ]
    ...
    def test_write_csv(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            protein_features = [
                ...
                ProteinFeatures(
                    identifier="P2", features={"length": "142", "genus": "Mus"}
                ),
            ]
...
class TestIntegration:
    ...
    def test_to_pd_feature_filtering(
        ...
        extractor = ProteinFeatureExtractor(
            headers=headers, features=requested_features
        )
...
class TestConstants:
    ...
    def test_default_features_constant(self):
        ...
        assert len(DEFAULT_FEATURES) == len(UNIPROT_FEATURES) + len(
            TAXONOMY_FEATURES
        ) + len(INTERPRO_FEATURES)
